...
public class TabList extends JPanel{
    JPanel columnpanel;
    public ArrayList<TrajectoireInfo> plans = new ArrayList<>();
    JPanel borderlaoutpanel ;
    public TabList(ArrayList<TrajectoireInfo> pi)
    {
        setLayout(null);
        JScrollPane scrollPane = new JScrollPane();
        scrollPane.setBounds(10, 10, 340, 150);
        add(scrollPane);
        ...
        {
            pi.get(i).setPreferredSize(new Dimension(360, 50));
            plans.add(pi.get(i));
    ...
    public void addNewInfo(TrajectoireInfo p)
    {
