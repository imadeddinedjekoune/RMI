...
import static GUIMap.Maps.ImagePanelZ8.tx;
import static GUIMap.Maps.ImagePanelZ8.ty;
...
public class ImagePanel extends JPanel{
        ...
        this.addMouseListener(new MouseListener() {
           ...
           public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2 && e.getButton() == MouseEvent.BUTTON1) 
                {
                    ...
                    RMI.ServeurRMI.MF.cv.aep.addPanel.mp.switchToZ8();
                    ...
                    double mercator[] = getLatLonFromXYInMap(xpos,ypos,MapLoader.y+y,MapLoader.x+x);
                        MapPanel.aePos = new Object[]{new double[]{mercator[0], mercator[1]},11};
                        RMI.ServeurRMI.MF.cv.aep.addPanel.t2.setText(""+mercator[0]+" , "+mercator[1]);
                        repaint();
                    }
                }
           }
    ...
    public void drawLocation(double lat,double lon,int zoom)
    {
        ...
        if(draw)
        {
            ImageUtils.drawLocation(copie,(x+stepx*1024),(y+stepy*1024));
        }
    ...
    public void drawAr(double lat,double lon,int zoom)
    {
        ...
        if(draw)
        {
            ImageUtils.drawAr(copie,(x+stepx*1024),(y+stepy*1024));
        }
