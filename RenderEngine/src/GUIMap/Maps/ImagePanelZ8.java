...
public class ImagePanelZ8 extends JPanel
{
    ...
    public ImagePanelZ8()
    {
        try {
            ...
            img = ImageIO.read(new File("MapZoom8.tif"));
        ...
        this.addMouseListener(new MouseListener() {
           ...
           public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2 && e.getButton() == MouseEvent.BUTTON1) 
                {
                    ...
                    renderengine.RenderEngine.mfMap.mp.ip = new ImagePanel();


                    renderengine.RenderEngine.mfMap.mp.ip.setBounds(0, 0,640, 640);

                    renderengine.RenderEngine.mfMap.mp.switchToZ11();
                }
           }
